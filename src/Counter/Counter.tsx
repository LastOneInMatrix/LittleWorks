...
export const Counter = (props: CounterPropsType) => {
    return <div className={styles.app}>
        <div className={styles.main}>
            <InfoPart showSettings={true} viewMode={props.viewMode} maxValue={props.maxValue}
                      changeValue={props.changeValue} disabled={props.disabled} count={props.count}
                      whatToRender={props.whatDisplay}/>
            <div className={styles.buttonsArea}>
                {
                    props.whatDisplay === 'custom' ?
                        <Button text={'set'} onClick={props.onChangeView} disabled={props.disabled}/>
